...
class MstActivityLogModelConfig(models.Model):
    ...
    include_related_line_models = fields.Boolean(
        ...
        help="If enabled, selecting Sale Order will also include Sale Order Lines, "
             "Purchase Order will include Purchase Order Lines, Invoice will include Journal Items, "
             "and Stock Picking will include Stock Moves and Stock Move Lines."
    )
    ...
    def _compute_name(self):
        for record in self:
            if record.model_ids:
                ...
                record.name = _("Model Log Configuration")
            ...
            for config in other_configs:
                ...
                if duplicate_ids:
                    ...
                    raise ValidationError(
                        _("These models are already configured in another active configuration: %s")
    ...
    def action_view_model_logs(self):
        ...
        return {
            ...
            "name": _("%s Logs") % (self.name or _("Model")),
